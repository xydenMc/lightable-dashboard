...
<head>
    ...
    <style>
        .card-stats { transition: all 0.3s; border-radius: 15px; }
        .card-stats:hover { transform: translateY(-5px); box-shadow: 0 5px 15px rgba(0,0,0,0.1); }
        ...
        .user-table tr { transition: all 0.2s; }
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3><?= number_format($total_likes) ?></h3>
